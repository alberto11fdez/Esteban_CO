...
CREATE TABLE IF NOT EXISTS `estebanco`.`Rol` (
  ...
  PRIMARY KEY (`Persona_id`, `Cuenta_id`),
...
CREATE TABLE IF NOT EXISTS `estebanco`.`conversacion` (
  ...
  PRIMARY KEY (`idconversacion`, `Persona_id`, `Asistente_id`),
...
CREATE TABLE IF NOT EXISTS `estebanco`.`mensaje` (
  ...
  `conversacion_Persona_id` INT NOT NULL,
  `conversacion_Asistente_id` INT NOT NULL,
  PRIMARY KEY (`idmensaje`, `conversacion_idconversacion`, `conversacion_Persona_id`, `conversacion_Asistente_id`),
  INDEX `fk_mensaje_conversacion1_idx` (`conversacion_idconversacion` ASC, `conversacion_Persona_id` ASC, `conversacion_Asistente_id` ASC) VISIBLE,
  CONSTRAINT `fk_mensaje_conversacion1`
    FOREIGN KEY (`conversacion_idconversacion` , `conversacion_Persona_id` , `conversacion_Asistente_id`)
    REFERENCES `estebanco`.`conversacion` (`idconversacion` , `Persona_id` , `Asistente_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
